...
def calculate_time_estimate(task: oldModels.Task) -> oldModels.Task:
    """
...
def calculate_time_of_completion(task: oldModels.Task) -> oldModels.Task:
    """
...
def calculate_efficiency(task: oldModels.Task) -> float:
